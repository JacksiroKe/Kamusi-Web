...
@section('content')
    ...
    <div class="container-fluid mt--7">
        <div class="row">
            ...
            @if (isset($word->synonyms) && $word->synonyms)
                <?php
                    $varSynonyms = explode(",", $word->synonyms); 
                ?>
                    ...
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-6 text-right">
                                <a href="{{ route('questions.create', $word->id) }}" class="btn btn-sm btn-primary">NEW QUESTION</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
